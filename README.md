...
1. Fork this repo
1. After forking the repo, open the [`vercel.json`](https://github.com/rogerpss/github-readme-stats/blob/master/vercel.json#L5) file and change the `maxDuration` field to `10`
...
<!---
rogerpss/rogerpss is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
